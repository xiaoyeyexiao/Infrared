...
# def identify_gray_body(image_path):
#     # 加载预训练的 DeepLabv3 模型
#     model = models.segmentation.deeplabv3_resnet50(pretrained=True)
#     model.eval()
#     # 加载图像
#     image_path = '/home/yechentao/Programs/Infrared/image/gray4/frame_1.jpg'
...
#     print("头的上边:", head_top_row)

#     mid_row = head_top_row + int((black_image.shape[0] -head_top_row) * 0.4)
#     black_image = black_image[0:mid_row, :, :] 
#     # 遍历每个轮廓
#     for contour in contours:
#         # 在当前轮廓中找到具有最小y值的点
#         for point in contour:
...
#                 head_right_col = x
#     print("头的左边:", head_left_col)
#     print("头的右边:", head_right_col)
#     return black_image, [head_top_row, head_left_col, head_right_col]
...
#     # 显示图片
#     cv2.imshow('Resizable Window', black_image)
#     # 调整窗口大小
...
def identify_gray_body(image_path):
    ...
    model.eval()
    # 加载图像
    # image_path = '/home/yechentao/Programs/Infrared/image/color10/frame_1.jpg'
    input_image = preprocess_image(image_path)
    ...
    mid_row = head_top_row + int((output_image.shape[0] -head_top_row) * 0.45)
    ...
    print("头的左边:", head_left_col)
    print("头的右边:", head_right_col)
    return output_image, [head_top_row, head_left_col, head_right_col], mid_row
    # """显示图片"""
    # print("-----show image-----")
    # # 创建窗口
    # cv2.namedWindow('Resizable Window', cv2.WINDOW_NORMAL)
